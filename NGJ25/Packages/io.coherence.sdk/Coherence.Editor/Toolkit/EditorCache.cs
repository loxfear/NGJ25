...
namespace Coherence.Toolkit
{
    ...
    internal static class EditorCache
    {
        ...
        public static bool UpdateBindings(CoherenceSync sync, bool forceUpdate = false)
        {
            ...
            changed |= OverrideActions.PruneLeakedManagedIds(sync);
            ...
            foreach (var component in cachedComponents)
            {
                ...
                foreach (var descriptor in descriptors)
                {
                    ...
                    if (descriptor.MemberType == MemberTypes.Field ||descriptor.MemberType == MemberTypes.Property ||
                        descriptor.MemberType == MemberTypes.Method)
                    {
