...
namespace Coherence.Editor.Toolkit
{
    ...
    internal static class ContentUtils
    {
        ...
        public class GUIStyles
        {
            ...
            public static readonly GUIStyle centeredLabel = new(EditorStyles.centeredGreyMiniLabel)
            {
                wordWrap = true,
            };
            ...
            public static readonly GUIStyle centeredStretchedLabel = new(centeredLabel)
            {
                stretchWidth = true,
                stretchHeight = true,
            };
        ...
        {
            return IsCompatible(descriptor, sync)
                ? EditorGUIUtility.TrTextContent(descriptor.Signature)
                : GetInvalidContent(descriptor,
                    "Incompatible in reflection mode. Add a baked script to bind to this member.");
        }
        ...
        {
            return descriptor.MethodCompatibility.HasFlag(sync.usingReflection
                ? TypeUtils.MethodCompatibility.Reflected
                : TypeUtils.MethodCompatibility.Baked);
        }
        ...
        public static void DrawSelectableLabel(string text, GUIStyle guiStyle,
            bool honorIndent = false)
        {
