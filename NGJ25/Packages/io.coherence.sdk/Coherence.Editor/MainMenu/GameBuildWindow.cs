...
namespace Coherence.Editor
{
    ...
    internal class GameBuildWindow : EditorWindow
    {
        ...
        internal static void DrawShareBuildGUI()
        {
            ...
            CoherenceHubLayout.DrawDiskPath(buildPath, infoString, GetBuildSelector(), (newPath) =>
            {
                buildPath = newPath;
            ...
            CoherenceHubLayout.DrawCloudDependantButton(new GUIContent("Begin Upload"), () =>
            {
                if (!validBuildPath)
                {
