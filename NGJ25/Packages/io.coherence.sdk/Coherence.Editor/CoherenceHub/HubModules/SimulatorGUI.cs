...
namespace Coherence.Editor
{
    ...
    internal static class SimulatorGUI
    {
        ...
        internal static void DrawLocalSimulatorBuild(SimulatorBuildOptions buildOptions)
        {
            ...
            DrawLocalBuildInformation(IsLocalBuildSymbolDefined(buildOptions));
        }
        ...
        private static void DrawLocalBuildInformation(bool localBuildSymbolIsDefined)
        {
            if (!localBuildSymbolIsDefined)
            {
                CoherenceHubLayout.DrawMessageArea("COHERENCE_SIMULATOR scripting symbol");
            }
        }
            ...
            ScriptingImplementation scriptingImplementation)
        {
            ...
            if (!simulatorBuildBlocker.HasFlag(SimulatorBuildBlocker.LinuxDedicatedServerBuildSupportInstalled) &&
                simulatorBuildBlocker.HasFlag(SimulatorBuildBlocker.LinuxBuildSupportInstalled))
            {
            ...
            else if (!simulatorBuildBlocker.HasFlag(SimulatorBuildBlocker.LinuxDedicatedServerBuildSupportInstalled) &&
                     !simulatorBuildBlocker.HasFlag(SimulatorBuildBlocker.LinuxBuildSupportInstalled))
            {
