    ...
    public class CoherenceSyncObjectsStandaloneWindow : EditorWindow
    {
        ...
        private static class GUIContents
        {
            ...
            public static readonly GUIContent controls = new(
                $"Click to select a {nameof(CoherenceSyncConfig)}.\n" +
                $"{GetOsSpecificModifier()}-Click to select the associated {nameof(CoherenceSync)}.\n" +
                "Double-Click to open the Configure Window and start networking.");
