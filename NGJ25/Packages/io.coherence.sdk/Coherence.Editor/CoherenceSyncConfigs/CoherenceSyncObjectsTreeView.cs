...
namespace Coherence.Editor
{
    ...
    public class CoherenceSyncObjectsTreeView : TreeView
    {
        ...
        private void AddNode(TreeViewItem root, CoherenceSyncConfig config)
        {
            ...
            {
                root.children.Insert(0, groupTreeViewItem);
            }
            else
            {
        ...
        static MultiColumnHeaderState.Column[] GetColumns()
        {
            ...
            retVal[counter].headerContent = new GUIContent("Object Name", "Network Asset Name");
            ...
            retVal[counter].headerContent = new GUIContent("Config Name", "Coherence Sync Config Name");
            retVal[counter].minWidth = 100;
            retVal[counter].width = 260;
            retVal[counter].maxWidth = 10000;
            retVal[counter].headerTextAlignment = TextAlignment.Left;
