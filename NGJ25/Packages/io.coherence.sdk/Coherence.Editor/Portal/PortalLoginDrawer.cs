...
namespace Coherence.Editor.Portal
{
    ...
    internal class PortalLoginDrawer
    {
        ...
        public static float DrawOrganizationOptions()
        {
            ...
            CoherenceHubLayout.DrawLabel(orgLabel, null, GUILayout.Width(labelWidth), GUILayout.Height(height));
        ...
        public static void DrawProjectOptions(float labelWidth)
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                CoherenceHubLayout.DrawLabel(new GUIContent(projLabel), null, GUILayout.Width(labelWidth),
