...
namespace Coherence.Runtime.Tests
{
    ...
    internal sealed class FakeCloudStorageBuilder
    {
        ...
        public CloudStorage Build()
        {
            ...
            {
                var requestFactory = requestFactoryBuilder.Build().Object;
                cloudStorage = new (requestFactory, authClient.Build().Object, requestFactory.Throttle, operationQueueFactory);
            }
