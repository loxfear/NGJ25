...
namespace Coherence.Cloud
{
    ...
    {
        /// <summary>
        /// The user that was successfully logged in, or <see langword="User.None"/> if the login operation failed.
        /// </summary>
        ...
        /// </para>
        /// </summary>
        public SessionToken SessionToken => User.SessionToken;
        ...
        internal LoginResult(UserGuid guid, string username, string guestPassword, Result resultType, LoginResponse response)
        {
            User = new User(guid, response.UserId, username, new(response.SessionToken));
