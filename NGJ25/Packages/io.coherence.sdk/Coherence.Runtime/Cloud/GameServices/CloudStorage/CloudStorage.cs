...
namespace Coherence.Cloud
{
    ...
    {
        private const string BasePath = "/cloudstorage";
        private const string LoadRequestMethod = "POST";
        private const string SaveRequestMethod = "PUT";
        private const string DeleteRequestMethod = "DELETE";
