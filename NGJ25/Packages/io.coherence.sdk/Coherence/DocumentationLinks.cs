...
namespace Coherence
{
    ...
    internal static class DocumentationLinks
    {
        ...
        private static Dictionary<DocumentationKeys, string> documentationLinks = new()
        {
            ...
            { DocumentationKeys.MRS, "/manual/simulation-server/multi-room-simulators" },
        ...
        public static string GetDocsUrl(DocumentationKeys key = DocumentationKeys.None)
        {
            ...
            var baseUrl = settings && settings.VersionInfo is { UseUnpublishedDocsUrl: true }
                ? GetUnpublishedDocsBaseUrl()
                : GetDocsBaseUrl();
