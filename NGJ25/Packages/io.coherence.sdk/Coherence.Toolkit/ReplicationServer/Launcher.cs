...
namespace Coherence.Toolkit.ReplicationServer
{
    ...
    public static class Launcher
    {
        ...
        {
#if UNITY_PS5
            throw new PlatformNotSupportedException("This platform does not support self-hosting.");
#if COHERENCE_HAS_RSL
            serverConfig.UseLite = true;
#else
            throw new InvalidOperationException("Console builds require the Replication Server Lite package.");
#endif
#endif
