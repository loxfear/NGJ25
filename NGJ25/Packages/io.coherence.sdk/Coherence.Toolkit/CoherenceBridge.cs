...
namespace Coherence.Toolkit
{
    ...
    [NonBindable]
    [HelpURL("https://docs.coherence.io/v/1.5/manual/components/coherence-bridge")]
    public sealed class CoherenceBridge : CoherenceBehaviour, ICoherenceBridge, IDisposable
    {
        ...
        /// </param>
        private async ValueTask DisposeAsync(bool waitForOngoingCloudOperationsToFinish)
        {
            shouldDisposeCloudService = true;
            CoherenceLoop.RemoveBridge(this);
            Client?.Dispose();
        ...
        private void OnDestroy() => _ = DisposeAsync(waitForOngoingCloudOperationsToFinish: true);
