...
namespace Coherence.Generated
{
    ...
    public class Binding_697a6db130ecfc64684cadb8c098e011_9aedbf950ead4540b50206275550e9aa : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_697a6db130ecfc64684cadb8c098e011 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_697a6db130ecfc64684cadb8c098e011>();
        ...
        {
            ["9aedbf950ead4540b50206275550e9aa"] = new Binding_697a6db130ecfc64684cadb8c098e011_9aedbf950ead4540b50206275550e9aa(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_697a6db130ecfc64684cadb8c098e011()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_697a6db130ecfc64684cadb8c098e011 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_697a6db130ecfc64684cadb8c098e011>();
            this.bridge = bridge;
